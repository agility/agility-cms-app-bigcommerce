	...
	return (
		<div className="bg-white">
			<div className="max-w-lg bg-gray-50 rounded shadow m-auto p-5 mt-10 space-y-3">
				<h2 className="text-xl font-medium">Agility BigCommerce Connector</h2>
				<p className="">Please edit the configuration of your BigCommerce App in the Agility content manager.</p>
				<div className="">
					<Button
